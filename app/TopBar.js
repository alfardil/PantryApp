      ...
      >
        ...
        {user ? (
          <Box display="flex" alignItems="center" style={{flexWrap:"wrap"}}>
            <Typography variant="body1" style={{ marginRight: '16px' }} className="space-mono-regular">
              Hello, {user.email}
            </Typography>
            <Button color="inherit" onClick={onLogout} className="space-mono-regular">Logout</Button>
          </Box>
        ) : (
